...
(function ($) {
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<hr><div style="float:left;text-align: left;"><input class="btn_1" type="submit" value="确定"></div>'),
            ...
            function addItem(file) {
                ...
                var removeLink = $('<span class="uploader__file-list__button"><button style="color: red;" class="uploader__icon-button js-upload-remove-button fa fa-times" data-index="' + id + '">×</button></span>');
            ...
            function uploadSubmitHandler() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        alert("成功");
                        window.location.href = "http://localhost:8002/static/resources/" + options.locateHtml;
                    }
                });
            }
